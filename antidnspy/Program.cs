...
namespace antidnspy
{
    internal static class AntiDnSpy
    {
        ...
        private static void Read()
        {
            ...
            {
                MessageBox((IntPtr)0, "dnSpy has been detected on ur computer, since it can be used for malicious ending, the program will be deleted from ur computer...", "Anti DNSPY by papope, inspired by Rzy", 0);
